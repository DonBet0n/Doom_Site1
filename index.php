  ...
  <ul class="menu__box">
    ...
    <li><a class="menu__item" href="#">Контакти</a></li>
            ...
            <div class="header_main_wrapper">
                <div class="name_site"><h1>doom eternal</h1></div>
                <div class="img">
        ...
        <div class="categories_wrapper">
            ...
            <div class="categories_content">
                ...
                <div class="content_row">
                    <div class="categories_block bck_cont_1">
                        <a href="Info.php">
                            <div class="categories_block_title">Doom Eternal: Info</div>
                        </a>
                    </div>

                    <div class="categories_block bck_cont_2">
                        <a href="#">
                ...
                <div class="content_row">
                    ...
                    <div class="categories_block bck_cont_3">
                        <a href="#">
                            <div class="categories_block_title">Demons</div>
                        </a>
                    </div>
                
                    <div class="categories_block bck_cont_4">
                        <a href="#">
                            <div class="categories_block_title">Guns</div>
                        </a>
                    </div>
              
                    <div class="categories_block bck_cont_5">
                        <a href="#">
